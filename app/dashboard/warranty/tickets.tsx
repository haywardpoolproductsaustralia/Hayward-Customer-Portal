...
// app/dashboard/warranty/tickets.tsx
//
// The warranty jobs UI. Split out of page.tsx so that page.tsx can be a SERVER
// component and refuse the route outright for groups that shouldn't have it
// (see lib/page-visibility.ts) - a client component can't redirect before it
// renders, and hiding only the nav link would leave a bookmarked URL working.
//
...
export default function WarrantyTickets() {
