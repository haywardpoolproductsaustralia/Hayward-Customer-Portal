          ...
          <table className="w-full text-left text-xs" style={{ minWidth: '2400px', tableLayout: 'auto', borderCollapse: 'collapse' }}>
            ...
            <thead className="sticky top-0 z-20">
              <tr className="text-[11px] font-bold uppercase tracking-widest">
                ...
                <th colSpan={5} style={{ background: '#0ea5e9', color: 'white', padding: '6px 12px' }}>
                  AS400 Delivery Address
                </th>
              </tr>
              <tr className="border-b border-slate-200 text-[11px] font-semibold uppercase tracking-wide">
                <th className="sticky left-0 z-10 bg-slate-800 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider">PO</th>
                <th className="sticky bg-slate-700 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ left: '75px' }}>Status</th>
                <th className="sticky bg-slate-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider border-r border-slate-500" style={{ left: '165px' }}>Type</th>
                <th className="sticky bg-emerald-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ left: '255px' }}>Stock code</th>
                <th className="sticky bg-emerald-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ left: '385px' }}>Supplier SKU</th>
                <th className="sticky bg-emerald-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ left: '505px' }}>Description</th>
                <th className="sticky bg-emerald-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ left: '705px' }}>Order date</th>
                <th className="sticky bg-emerald-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ left: '805px' }}>ETA Arrow</th>
                <th className="sticky bg-emerald-600 px-3 py-3 text-right whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ left: '905px' }}>Ordered</th>
                <th className="sticky bg-emerald-600 px-3 py-3 text-right whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider border-r-2 border-emerald-400" style={{ left: '980px' }}>Received</th>
                <th className="sticky bg-amber-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ zIndex: 9 }}>Arrow PO ref</th>
                <th className="sticky bg-amber-600 px-3 py-3 text-right whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ zIndex: 9 }}>ENT</th>
                <th className="sticky bg-amber-600 px-3 py-3 text-right whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ zIndex: 9 }}>SHPD</th>
                <th className="sticky bg-amber-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ zIndex: 9 }}>Order date</th>
                <th className="sticky bg-amber-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ zIndex: 9 }}>ETA</th>
                <th className="sticky bg-amber-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider border-r-2 border-amber-300" style={{ zIndex: 9 }}>US SO#</th>
                <th className="sticky bg-violet-600 px-4 py-3 text-center whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ zIndex: 9, minWidth: '110px' }}>On water</th>
                <th className="sticky bg-violet-600 px-4 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ zIndex: 9, minWidth: '130px' }}>Container</th>
                <th className="sticky bg-violet-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ zIndex: 9 }}>Vessel</th>
                <th className="sticky bg-violet-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ zIndex: 9 }}>Cont. ETA</th>
                <th className="sticky bg-violet-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider border-r-2 border-violet-300" style={{ zIndex: 9 }}>Supplier</th>
                <th className="sticky bg-sky-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ zIndex: 9 }}>Ship to</th>
                <th className="sticky bg-sky-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ zIndex: 9 }}>City</th>
                <th className="sticky bg-sky-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ zIndex: 9 }}>State</th>
                <th className="sticky bg-sky-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ zIndex: 9 }}>Postcode</th>
                <th className="sticky bg-sky-600 px-3 py-3 whitespace-nowrap text-white font-bold uppercase text-xs tracking-wider" style={{ zIndex: 9 }}>Addr OK?</th>
              </tr>
            </thead>
              ...
              {filtered.length === 0 ? (
                ...
                filtered.map((r, i) => {
                  ...
                  return (
                    ...
                    >
                      <td className="sticky left-0 z-10 bg-slate-900 px-3 py-3 whitespace-nowrap">
                        <Link href={`/dashboard/reconciliation?po=${r.po}`} className="font-bold text-white hover:text-wave">{r.po}</Link>
                      </td>
                      <td className="sticky bg-slate-800 px-3 py-3" style={{ left: '75px' }}>
                        {statusBadge(r.status)}
                      </td>
                      <td className="sticky bg-slate-700 px-3 py-3 border-r border-slate-600" style={{ left: '165px' }}>
                        {supplierTypeBadge(r.creditor, r.stockCategory)}
                      </td>
                      <td className="sticky bg-emerald-50 px-3 py-3 font-mono text-[11px] whitespace-nowrap text-slate-800 font-semibold" style={{ left: '255px' }}>{r.arrowStock}</td>
                      <td className="sticky bg-emerald-50 px-3 py-3 font-mono text-[11px] whitespace-nowrap text-slate-700 font-semibold" style={{ left: '385px' }}>{r.supplierSku || '—'}</td>
                      <td className="sticky bg-emerald-50 px-3 py-3 text-slate-800 font-medium" style={{ left: '505px' }} title={r.description ?? ''}>{r.description ?? '—'}</td>
                      <td className="sticky bg-emerald-50 px-3 py-3 whitespace-nowrap text-slate-600 font-medium" style={{ left: '705px' }}>{fmt(r.orderDate)}</td>
                      <td className="sticky bg-emerald-50 px-3 py-3 whitespace-nowrap text-slate-700 font-medium" style={{ left: '805px' }}>
                        {fmt(r.requestedDate)}
                        {r.lateVsRequest && <span className="ml-1 text-red-500 text-lg" title="Late vs requested date">&#x26A0;</span>}
                      </td>
                      <td className="sticky bg-emerald-50 px-3 py-3 text-right font-bold text-emerald-900 text-lg" style={{ left: '905px' }}>{r.qtyOrdered}</td>
                      <td className="sticky bg-emerald-50 px-3 py-3 text-right text-slate-600 font-semibold border-r-2 border-emerald-300" style={{ left: '980px' }}>{r.qtyReceived}</td>
                      <td className="bg-amber-50 px-3 py-3 whitespace-nowrap font-mono text-[11px] font-semibold">
                        {r.as400Ord === 0
                          ? <span className="text-red-400">—</span>
                          : <span className="text-green-700">&#10003; {r.po}</span>
                        }
                      </td>
                      <td className="bg-amber-50 px-3 py-3 text-right font-bold text-lg">
                        {r.as400Ord === 0
                          ? <span className="text-red-600">missing</span>
                          : <span className="text-amber-900">{r.as400Ord}</span>}
                      </td>
                      <td className="bg-amber-50 px-3 py-3 text-right text-amber-800 font-semibold">{r.as400Shpd || '—'}</td>
                      <td className="bg-amber-50 px-3 py-3 whitespace-nowrap text-slate-600 font-medium">{fmt(r.as400OrderDate)}</td>
                      <td className="bg-amber-50 px-3 py-3 whitespace-nowrap text-slate-600 font-medium">{fmt(r.as400Eta)}</td>
                      <td className="bg-amber-50 px-3 py-3 font-mono text-[11px] text-slate-600 font-semibold border-r-2 border-amber-200">{r.usSoNumber ?? '—'}</td>
                      <td className="bg-violet-50 px-4 py-3.5 text-center">
                        {r.onWater > 0
                          ? <span className="inline-flex items-center justify-center bg-gradient-to-b from-violet-300 to-violet-400 text-white font-bold rounded-lg px-4 py-2 text-sm shadow-md">{r.onWater}</span>
                          : <span className="text-slate-300 text-sm">—</span>}
                      </td>
                      <td className="bg-violet-50 px-4 py-3.5 font-mono text-sm whitespace-nowrap text-violet-700 font-semibold tracking-wide">{r.container ?? '—'}</td>
                      <td className="bg-violet-50 px-3 py-3.5 whitespace-nowrap text-slate-700 font-medium">{r.vessel ?? '—'}</td>
                      <td className="bg-violet-50 px-3 py-3.5 whitespace-nowrap text-slate-600 font-medium">{fmt(r.containerEta)}</td>
                      <td className="bg-violet-50 px-3 py-3.5 whitespace-nowrap text-slate-600 font-medium border-r-2 border-violet-200">
                        {creditorName[r.creditor ?? ''] ?? r.creditor ?? '—'}
                      </td>
                      <td className="bg-sky-50 px-3 py-3.5 whitespace-nowrap text-slate-700 font-medium" title={r.shipToName ?? ''}>{r.shipToName ?? '—'}</td>
                      <td className="bg-sky-50 px-3 py-3.5 whitespace-nowrap text-slate-700 font-medium">{r.shipToCity ?? '—'}</td>
                      <td className="bg-sky-50 px-3 py-3.5 whitespace-nowrap text-slate-600 font-medium">{r.shipToState ?? '—'}</td>
                      <td className="bg-sky-50 px-3 py-3.5 whitespace-nowrap text-slate-600 font-medium">{r.shipToPostcode ?? '—'}</td>
                      <td className="bg-sky-50 px-3 py-3.5 whitespace-nowrap font-medium">
                        {r.as400Ord === 0 ? (
